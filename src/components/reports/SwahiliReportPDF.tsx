...
interface SwahiliReportPDFProps {
  reports: SwahiliReport[];
  targetInfo: {
    url: string;
    webServer: string;
    ipAddress: string;
...
export const SwahiliReportPDF = ({ reports, targetInfo }: SwahiliReportPDFProps) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <Text style={styles.title}>Swahili Security Report</Text>
