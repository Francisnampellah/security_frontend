    ...
    <div className="flex flex-col min-h-screen bg-[#f8fbff]">
      ...
      <nav className="w-full bg-white border-b border-blue-100/60 py-3 px-4 md:px-12 flex items-center justify-between sticky top-0 z-20">
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-gray-700">
          ...
          <a href="/about" className="hover:text-blue-600 transition text-blue-600">About</a>
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 text-gray-900">About VulnGuard</h1>
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            VulnGuard is a modern, user-friendly web vulnerability assessment platform designed for SMEs and security professionals.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow p-8 flex flex-col items-center text-center">
            ...
            <p className="text-gray-500">To empower organizations with real-time, actionable security insights and make vulnerability management simple and accessible.</p>
          </div>
          <div className="bg-white rounded-xl shadow p-8 flex flex-col items-center text-center">
            <Zap className="w-10 h-10 text-blue-500 mb-3" />
            <h2 className="text-xl font-semibold mb-2 text-gray-900">Our Technology</h2>
            <p className="text-gray-500">Built on proven open-source tools and cloud-native infrastructure, VulnGuard delivers fast, reliable, and scalable security scanning.</p>
          </div>
        </div>
        <div className="bg-white rounded-xl shadow p-8 mb-12">
          <h2 className="text-2xl font-bold mb-6 text-blue-600 flex items-center"><Server className="w-7 h-7 mr-2" /> Our Stack</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="font-semibold text-gray-900 mb-2 flex items-center"><Code className="w-5 h-5 mr-1 text-blue-500" /> Frontend</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2 flex items-center"><Server className="w-5 h-5 mr-1 text-blue-500" /> Backend</h3>
              <ul className="text-gray-500 text-sm space-y-1">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-2 flex items-center"><Zap className="w-5 h-5 mr-1 text-blue-500" /> Scanner</h3>
              <ul className="text-gray-500 text-sm space-y-1">
                <li>OWASP ZAP</li>
                <li>Automated & Active Scanning</li>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-xl shadow p-8">
            <h3 className="text-xl font-semibold mb-4 text-blue-600 flex items-center"><Bug className="w-5 h-5 mr-2" /> Key Features</h3>
            <ul className="text-gray-500 text-sm space-y-2 list-disc pl-5">
              <li>Real-time vulnerability scanning</li>
              <li>Comprehensive, actionable reports</li>
              <li>Easy integration and setup</li>
              <li>Secure, containerized architecture</li>
            </ul>
          </div>
          <div className="bg-white rounded-xl shadow p-8">
            <h3 className="text-xl font-semibold mb-4 text-blue-600 flex items-center"><Lock className="w-5 h-5 mr-2" /> Security First</h3>
            <ul className="text-gray-500 text-sm space-y-2 list-disc pl-5">
